...
{
    public BackpackMountains(string assetName, string prefabName, string itemName, string registerAs = null) : base(assetName, prefabName, itemName, registerAs: registerAs)
    {
