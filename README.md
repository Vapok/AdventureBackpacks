...
*Translations can be customized or added in the `Translations/` folder inside your AdventureBackpacks mod directory (`BepInEx/plugins/Vapok-AdventureBackpacks/Translations/`).*
